...
<html lang="en">
  ...
  <head>
    ...
    <title>SunPharma | Register Page</title>
  ...
  <body class="register-page bg-body-secondary">
    <div class="register-box">
      <div class="register-logo">
        <a href="../index2.html"><b>SunPharma</a>
        ...
        <div class="card-body register-card-body">
          ...
          <form action="{{route('save.employee')}}" method="post">
            ...
            <div class="input-group mb-3">
              <input type="text" class="form-control @error('username') is-invalid @enderror" placeholder="Full Name"
              name="username"/>
            ...
            <div class="input-group mb-3">
                ...
                <select class="form-select" id="validationCustom04" name="dep_id" required>
